...
function openlink(x) {
    if (x == 1) {
        window.open("https://www.instagram.com/bj_manish_45/", "_blank");
    }
    if (x == 2) {
        window.open("https://www.linkedin.com/in/manish-kumar-b591a1226/", "_blank");
    }
    if (x == 3) {
        window.open("https://github.com/bjmanish", "_blank");
    }
    if (x == 4) {
        window.open("https://manishportfolio.free.nf/", "_blank");
    }
}